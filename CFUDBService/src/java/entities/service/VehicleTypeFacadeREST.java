 ...
 */
@javax.ejb.Stateless
@Path("entities.vehicletype")
public class VehicleTypeFacadeREST extends AbstractFacade<VehicleType> {
    ...
    public VehicleType find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/json"})
    public List<VehicleType> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
